...
This costs exact-match score on 4 of 913 invoices. It intentionally
sacrifices corrected-total coverage rather than asserting an amount that cannot
be reconstructed from the available invoice evidence.
